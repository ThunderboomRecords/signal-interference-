...
```
cd existing_repo
git remote add origin https://gitlab.moeilijkedingen.nl/oct/open-culture-tech.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.moeilijkedingen.nl/oct/open-culture-tech/-/settings/integrations)
...
![Configuration should look like this](https://gitlab.moeilijkedingen.nl/oct/open-culture-tech/-/blob/5310a3e457873c5103b1184abea5682bf9d0aef1/images/iac-driver-setup.png)
